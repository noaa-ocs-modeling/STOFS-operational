...
cd ${DATA}/outputs; pwd
     ...
     rm -f geo_elev_out2d_?.nc

     ncks -x -v dryFlagNode,depthAverageVelX,depthAverageVelY,dryFlagElement,dryFlagSide out2d_1.nc -C geo_elev_out2d_1.nc 
     ncks -x -v dryFlagNode,depthAverageVelX,depthAverageVelY,dryFlagElement,dryFlagSide out2d_2.nc -C geo_elev_out2d_2.nc
     ncks -x -v dryFlagNode,depthAverageVelX,depthAverageVelY,dryFlagElement,dryFlagSide out2d_3.nc -C geo_elev_out2d_3.nc
...
# ------------------> archive
    ...
    list_day_n_f=(1 2 3)
    list_n_f=(nowcast forecast_day1 forecast_day2)
    ...
    let cnt=-1 
    for k_d in ${list_day_n_f[@]}
    do
  
      let cnt=$cnt+1
      str_n_f_k=${list_n_f[${cnt}]}
