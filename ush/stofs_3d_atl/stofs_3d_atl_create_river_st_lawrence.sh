...
# /lfs/h1/ops/dev/dcom/20230708/canadian_water/QC_02OA016_hourly_hydrometric.csv
  ...
  fn_in_st_law_riv=/lfs/h1/ops/dev/dcom/${yyyymmdd_today}/canadian_water/QC_02OA016_hourly_hydrometric.csv
  fn_in_st_law_riv_prev=/lfs/h1/ops/dev/dcom/${yyyymmdd_prev}/canadian_water/QC_02OA016_hourly_hydrometric.csv 
  ...
  if [[ -s flux.th ]] && [[ `wc -l flux.th | awk '{print $1}'` -ge 6 ]]; then
      ...
      msg="Attn - neither is available: St Lawrence Riv data"
