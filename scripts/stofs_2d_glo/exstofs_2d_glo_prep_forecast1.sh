...
#                                                                             #
###############################################################################
# Start of stofs_2d_glo_prep_forecast1.sh.ecf script ------------------------ #
# 0.  Preparation
# 0.a Basic modes of operation
  ...
  msg="Starting stofs_2d_glo_prep_forecast1 scripts"
  echo "$msg"
...
# 7.  Send files to $COM
  ...
  msg="Completing stofs_2d_glo_prep_forecast1 script"
  echo "$msg"
  postmsg "$jlogfile" "$msg"

# End of stofs_2d_glo_prep_forecast1.sh.ecf script -------------------------- #
