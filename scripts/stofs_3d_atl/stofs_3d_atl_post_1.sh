...
#  forms), execpt the 2-D field nc files (which are created stofs_3d_atl_post_2.sh  #
#                                                                                   #
#  Remarks:                                                                         #
#                                                               September, 2022     #
#####################################################################################

# stofs_3d_atl_post_processing.sh 
...
# ----------------------->
  ...
  fn_this_sh="stofs_3d_atl_post_1"
